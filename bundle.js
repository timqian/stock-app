...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _historyLibCreateHashHistory2['default'])();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsCreateAll = __webpack_require__(217);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createProvider = __webpack_require__(218);

	var _createProvider2 = _interopRequireDefault(_createProvider);

	var _createConnect = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsCreateStoreShape = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions = __webpack_require__( // data
	228);
	...
	function isFetching(state, action) {
	  ...
	  switch (action.type) {
	    case _actions.REQUEST_SENT:
	      return true;
	    case _actions.RECEIVE_STOCK:
	    case _actions.RECEIVE_TAG_STOCKS:
	...
	function bigMoneys(state, action) {
	  ...
	  switch (action.type) {
	    case _actions.RECEIVE_BIG_MONEYS:
	      return action.bigMoneys;
	    default:
	      return state;
	  }
	}
	var stockApp = (0, _redux.combineReducers)({
	  username: username,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stock = __webpack_require__(229);

	var _events = __webpack_require__(243);

	var _tagStocks = __webpack_require__(244);

	var _bigMoneys = __webpack_require__(245);
	...
	exports.RECEIVE_STOCK = _stock.RECEIVE_STOCK;
	exports.receiveStock = _stock.receiveStock;
	exports.fetchStock = _stock.fetchStock;
	exports.RECEIVE_EVENTS = _events.RECEIVE_EVENTS;
	exports.receiveEvents = _events.receiveEvents;
	exports.fetchEvents = _events.fetchEvents;
	exports.RECEIVE_TAG_STOCKS = _tagStocks.RECEIVE_TAG_STOCKS;
	exports.receiveTagStocks = _tagStocks.receiveTagStocks;
	exports.fetchTagStocks = _tagStocks.fetchTagStocks;
	exports.RECEIVE_BIG_MONEYS = _bigMoneys.RECEIVE_BIG_MONEYS;
	exports.receiveBigMoneys = _bigMoneys.receiveBigMoneys;
	exports.fetchBigMoneys = _bigMoneys.fetchBigMoneys;
	exports.LOGIN_SUCCESS = _auth.LOGIN_SUCCESS;
	exports.LOGOUT = _auth.LOGOUT;
	exports.SIGNUP_SUCCESS = _auth.SIGNUP_SUCCESS;
	exports.signup = _auth.signup;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RECEIVE_STOCK = RECEIVE_STOCK;
	...
	function fetchStock(_id) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('going to fetchStock'));

	    var addr = _index.address + '/Stocks/' + _id;
	    // console.log(addr);
	    _axios2['default'].get(addr, {
	      params: {
	        select: {
	          name: 1,
	          tags: 1
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.RECEIVE_EVENTS = RECEIVE_EVENTS;
	...
	function fetchEvents(_id) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('going to fetchEvents'));

	    var addr = _index.address + '/Events';
	    _axios2['default'].get(addr, { //as: `?query={"tags":{"$in":["国企"]}}`
	      params: {
	        query: {
	          stockId: _id
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveTagStocks = receiveTagStocks;
	exports.fetchTagStocks = fetchTagStocks;
	...
	var RECEIVE_TAG_STOCKS = 'RECEIVE_TAG_STOCKS';

	exports.RECEIVE_TAG_STOCKS = RECEIVE_TAG_STOCKS;

	function receiveTagStocks(tagStocks) {
	  return {
	...
	function fetchTagStocks(tag) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('going to fetchTagStocks'));

	    var addr = _index.address + '/Stocks';
	    // console.log(tag);
	    _axios2['default'].get(addr, { //as: `?query={"tags":{"$in":["国企"]}}`
	      params: {
	        query: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveBigMoneys = receiveBigMoneys;
	exports.fetchBigMoneys = fetchBigMoneys;
	...
	var RECEIVE_BIG_MONEYS = 'RECEIVE_BIG_MONEYS';

	exports.RECEIVE_BIG_MONEYS = RECEIVE_BIG_MONEYS;

	function receiveBigMoneys(bigMoneys) {
	  return {
	...
	function fetchBigMoneys(_id) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('going to fetch BigMoneys'));
	    var addr = _index.address + '/BigMoneys';
	    _axios2['default'].get(addr, {
	      params: {
	        query: {
	          stockId: _id
...
/***/ function(module, exports, __webpack_require__) {
	...
	function signup(email, name, password) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('try to signup'));
	    _axios2['default'].post(_config.BASEURL + '/signup', { email: email, name: name, password: password }).then(function (res) {
	      dispatch(signupSuccess(name));
	      _utilsHistory2['default'].replaceState(null, '/');
	...
	function login(email, password /*, 原location*/) {
	  return function (dispatch) {
	    dispatch((0, _index.requestSent)('try to login'));
	    _axios2['default'].post(_config.BASEURL + '/login', { email: email, password: password }).then(function (res) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(251);

	var _componentsApp2 = _interopRequireDefault(_componentsApp);

	var _componentsMain = __webpack_require__(253);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsNavbar = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navbar = (function (_Component) {
	  ...
	  _createClass(Navbar, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        { className: 'pure-menu pure-menu-horizontal', style: navStyle.bar },
	        _react2['default'].createElement(
	          'a',
	          { href: '#', className: 'pure-menu-heading', style: navStyle.head },
	          'STOK'
	        ),
	...
	exports['default'] = (0, _reactRedux.connect)(select)(Navbar);
	module.exports = exports['default'];
